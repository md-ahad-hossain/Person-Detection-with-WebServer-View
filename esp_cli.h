...
static inline int task_dump_cli_handler(int argc, char *argv[]) {
...
static inline int cpu_dump_cli_handler(int argc, char *argv[]) {
...
static inline int mem_dump_cli_handler(int argc, char *argv[]) {
...
static inline int inference_cli_handler(int argc, char *argv[]) {
...
static inline esp_console_cmd_t diag_cmds[] = {
    { .command = "mem-dump", .help = "", .func = mem_dump_cli_handler },
    { .command = "task-dump", .help = "", .func = task_dump_cli_handler },
    { .command = "cpu-dump",  .help = "", .func = cpu_dump_cli_handler },
    { .command = "detect_image", .help = "detect_image <image_number>\nNote: image numbers 0-9 valid", .func = inference_cli_handler },
};

// -------------------- Image Database Init --------------------

static inline void image_database_init() {
...
// -------------------- CLI Task --------------------
static inline void esp_cli_task(void *arg) {
...
static inline int esp_cli_register_cmds() {
...
static inline int esp_cli_init() {
    image_database_init();
    static int cli_started = 0;
    if (cli_started) return 0;
